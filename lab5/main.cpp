/*
need four different types of customer: employee, student. visitor, construction
- each must store name, email, address, and two class-specific attributes
- each is a class

need 4 types of vehicles: car, motorcycle, truck, scooter
- must store make, model, year, and two class-specific attributes
- each is a class

"Invoice" class to store prices for each type of permit 
- at least one type of discount
    - discount for minivans
    - discount for physics majors
    - discount if car is registered in the state of Nevada
    
- at least one charge
    - charge for parking in wrong spot
    - charge for being a business major

- function that calculates total price
- function that generates invoice to the console containing total 
  price and all info entered by the user
